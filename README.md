...
- [Mastheads](https://api.mastheads.app/v1/mcp) - Read and write your own AI newsroom over MCP: articles, their sources, the checks, the editor of record. Read tools free; write and publish need a full-access key.
<br />
